...
import com.bookstore.di.DatabaseModule;
import com.bookstore.di.RepositoryModule;
...
public final class BookStoreApp_HiltComponents {
  private BookStoreApp_HiltComponents() {
  }
  ...
  @Singleton
  public abstract static class SingletonC implements BookStoreApp_GeneratedInjector,
  ...
  @Subcomponent(
      modules = {
          ...
          CatalogueViewModel_HiltModules.KeyModule.class,
  ...
  @Subcomponent(
      modules = {
          ...
          CatalogueViewModel_HiltModules.BindsModule.class,
